...
public class TaskController extends HttpServlet {
	...
	private void listMyTasks(HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
	...
	private void showCreateTaskForm(HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
	...
	private void showCreateAndAssignToCurrentUserForm(HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
	...
	private void showEditTaskForm(HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
	...
	private void approveTask(HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
	...
	private void createAndAssignToCurrentUser(HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
		...
		try {
			...
			if (status == null || title == null || description == null  ||
					 status.isEmpty() || title.isEmpty() || description.isEmpty()) {
			            throw new IllegalArgumentException("Make sure no fields empty");
			        }
	...
	private void createTask (HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
		...
		try {
			...
			if (status == null || title == null || description == null  || employeeId == null ||
					 status.isEmpty() || title.isEmpty() || description.isEmpty() || employeeId.isEmpty()) {
			            throw new IllegalArgumentException("Make sure no fields empty");
			        }
	...
	private void editTask(HttpServletRequest request, HttpServletResponse response, Employee currentUser) throws ServletException, IOException {
		try {
			String id = request.getParameter("id");
			String status = request.getParameter("taskStatus");
			String title = request.getParameter("taskTitle");
